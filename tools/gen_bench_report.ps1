<#
.SYNOPSIS
    Generate a benchmark report.md from an existing raw-log directory.
    Reuses the parsing logic from run_all_benches.ps1 so WSL results get
    the same structured report as Windows.
.PARAMETER LogDir
    Directory containing the *.log files (e.g. bench/results/wsl_20260809_195641).
#>
[CmdletBinding()]
param(

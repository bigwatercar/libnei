...
static_assert(sizeof(TimeDelta) == sizeof(int64_t), "TimeDelta must be exactly sizeof(int64_t)");
...
static_assert(sizeof(Time) == sizeof(int64_t), "Time must be exactly sizeof(int64_t)");
...
public:
  ...
  constexpr int64_t ToInternalValue() const {
    return ticks_;
  }
...
static_assert(sizeof(TimeTicks) == sizeof(int64_t), "TimeTicks must be exactly sizeof(int64_t)");

...
public:
  ...
  // Unlike POSIX epoll, Windows IOCP is technically thread-safe for
  // concurrent GetQueuedCompletionStatus callers, but we enforce
  // single-threaded driving as a design invariant to keep state
  // management simple.

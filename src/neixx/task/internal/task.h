...
struct Task {
  ...
  //   Within a single PooledTaskQueue's delayed heap, sequence_num is monotonically
  ...
  //   so operator> is only used within a single PooledTaskQueue's delayed_incoming_queue_.

...
// static
ReadOnlySharedMemoryMapping ReadOnlySharedMemoryMapping::CreateForPlatform(void *addr, std::size_t size) {
...
// static
WritableSharedMemoryMapping WritableSharedMemoryMapping::CreateForPlatform(void *addr, std::size_t size) {
